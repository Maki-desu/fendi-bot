...
- `/anime update channel:#anime-updates` enables hourly notifications for new anime episodes airing that day in the selected channel. It also checks immediately when configured. Requires Manage Server permission.
