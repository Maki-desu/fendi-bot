...
- `/anime update channel:#anime-updates` enables hourly notifications for new anime episodes airing that day in the selected channel. Requires Manage Server permission.
